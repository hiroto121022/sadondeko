...
export default function NFT({ allPosts: { edges }, preview }) {
  ...
  return (
    ...
    >
      <Layout preview={preview}>
        <Head>
          <title>NFT購入 | さどんでこNFT</title>
          <meta
          property="description"
          content="さどんでこNFTプロジェクトのNFT購入ページです。佐渡の鬼太鼓に魅了された新潟大学生5人が、「NFTアートで鬼太鼓おんでこを盛り上げたい」という思いから活動が始まりました。新潟大学生が佐渡の伝統文化「鬼太鼓」をデジタルアート（NFT）に落とし込むことで、「鬼太鼓」の認知を広め、文化継承を実現するために活動しています。"
        />
        <meta
          property="og:type"
          content="website"
