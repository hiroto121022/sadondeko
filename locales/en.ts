export default {
    ...
    PROJECTTEXT: "Five Niigata University students fascinated by Sado's Ondeko wanted to “enliven Ondeko with NFT art” and started this activity. By incorporating Sado's traditional Ondeko into digital art (NFT), Niigata University students are working to spread awareness of Ondeko and realize its cultural transmission.",
    ...
    HOME_TEXT_1: "Ondeko Digital Art (NFT) is a digital artwork that expresses Sado's traditional “Ondeko” culture. Furthermore, the art incorporates a mechanism that allows the art to evolve as visitors visit Sado Island, providing an opportunity for visitors to actually visit Sado Island and experience Ondeko.",
    HOME_IMAGE_1: "https://www.sadondeko.com/wp-content/uploads/2024/11/おんでこあーと_en.png",
    HOME_HEAD_2: "How you can contribute to Ondeko?",
    HOME_TEXT_2: "1) Share Ondeko art with your friends and spread Ondeko throughout Japan and the world.",
    HOME_TEXT_3: "2) By using Ondeko art as an opportunity to go and see Onidaiko in person, you can make Ondeko festivals more exciting.",
    HOME_TEXT_4: "3) Even if Ondeko has ceased to exist, just by having your art reproducing the appearance of Ondeko, the traditional culture will be handed down to the next generation.",
    ...
    EVOLVE_TITLE: "Evolution",
    EVOLVE_heading_1: "Conditions for evolving the NFT",
    EVOLVE_MASTER_1: "Congratulations! The NFT has already evolved.",
    EVOLVE_MASTER_2: "See the evolved NFT",
    EVOLVE_MINARAI_1: "You have not minted Ondeko NFT; please minted the NFT.",
    EVOLVE_MINARAI_2: "Mint Ondeko NFT.",
    EVOLVE_FELLOW_1: "You have minted Ondeko NFT",
    EVOLVE_FELLOW_2: "You are in Wassaki Area now.",
    EVOLVE_FELLOW_3: "Evolution is available! Evolve from the button below. (Gas cost will be charged)",
    EVOLVE_FELLOW_4: "Evolve!",
    EVOLVE_FELLOW_5: "Sorry, You do not have enough gas money to mint NFT to your wallet.",
    EVOLVE_FELLOW_6: "Let's go to Wassaki and check this page again!",   
}